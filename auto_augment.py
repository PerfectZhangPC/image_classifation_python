...
class AutoAugment(object):
    def __init__(self):
        ...
        self.policies = [
            ['Rotate', 0.7, 2, 'TranslateX', 0.3, 9],
            ['ShearY', 0.5, 8, 'TranslateY', 0.7, 9],
            ['ShearY', 0.2, 7, 'Rotate', 0.3, 7],
            ['TranslateY', 0.4, 3, 'Cutout', 0.6, 7],
            ['ShearX', 0.3, 9, 'TranslateX', 0.7, 9],
            ['Cutout', 0.6, 5, 'ShearX', 0.5, 1],
            ['ShearX', 0.6, 7, 'Cutout', 0.6, 5],
            ['TranslateY', 0.7, 7, 'TranslateX', 0.5, 8],
            ['Rotate', 0.3, 7, 'Cutout', 0.4, 8],
            ['TranslateY', 0.4, 3, 'ShearY', 0.2, 6],
            ['Brightness', 0.9, 6, 'Color', 0.2, 8],
            # ['Solarize', 0.5, 2, 'Invert', 0.0, 3],
            # ['Equalize', 0.2, 0, 'AutoContrast', 0.6, 0],
            # ['Equalize', 0.2, 8, 'Equalize', 0.6, 4],
